...
| Threads | 243 → 240 (1 owned) | 2,792 → 1,761 | no comment ids; 3 unrelated threads dropped with 850 comments; 5 posts exist only as comment targets → stubs; 394 comments landed on her 2023 post |
