  ...
  return (
    <section className="screen">
      ...
      <div className="wrap wide">
        <div className="stats">
          <div className="stat"><b>{fmtNum(t.comments)}</b><span>comments about {d.subject} from {fmtNum(t.accounts)} accounts, on {fmtNum(t.posts_with_comments)} posts{t.off_topic ? ` · ${fmtNum(t.off_topic)} unrelated comments set aside` : ""}</span></div>
