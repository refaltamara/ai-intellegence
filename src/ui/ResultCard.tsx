...
export function ResultCard({ tool, evidence, onOpenEvidence, decisionId = null, onOpenPane }: { tool: ToolCallRecord; evidence: Record<string, Evidence>; onOpenEvidence?: (ids: string[]) => void; decisionId?: string | null; onOpenPane?: () => void }) {
